...
import AdminHomeManagementPage from "@/pages/admin-home-management";
import AdminApiGeneratorPage from "@/pages/admin-api-generator";
import AdminAiStudioPage from "@/pages/admin-ai-studio";
import AdminAiIntegrationPage from "@/pages/admin-ai-integration";
...
function Router() {
  ...
  return (
    <>
      ...
      <Route path="/image/home-management" component={AdminHomeManagementPage} />
      <Route path="/image/api-generator" component={AdminApiGeneratorPage} />
      <Route path="/image/ai-studio" component={AdminAiStudioPage} />
      <Route path="/image/ai-integration" component={AdminAiIntegrationPage} />
