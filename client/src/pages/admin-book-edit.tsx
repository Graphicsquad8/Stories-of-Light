    ...
    <AdminLayout>
      <div className="max-w-4xl">
        ...
        {isLoading ? (
          ...
          <div className="grid gap-6">
            <Card className="p-6">
              <h2 className="font-semibold mb-4">Book Details</h2>
            ...
            <Card className="p-6">
              <div className="flex items-start gap-2 rounded-md border border-primary/20 bg-primary/5 p-3 mb-5">
              ...
              <div className={`space-y-2 ${type === "paid" ? "mt-5 pt-5 border-t" : ""}`}>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <Label htmlFor="book-published" className="cursor-pointer">Published (visible to visitors)</Label>
                </div>
