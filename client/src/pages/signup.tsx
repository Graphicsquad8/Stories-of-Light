...
const GOOGLE_ERROR_MESSAGES: Record<string, string> = {
  google_disabled: "Google login is currently disabled by the administrator.",
  google_not_configured: "Google login is not configured yet. Please contact the administrator.",
  google_cancelled: "Google sign-in was cancelled.",
  google_token_failed: "Google authentication failed. Please check the OAuth credentials in admin settings.",
  google_no_email: "No email was returned from Google. Please try a different account.",
