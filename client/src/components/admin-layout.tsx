...
import {
  ...
  Eye, UserCheck, Clock, Code2, Sparkles, BrainCircuit,
} from "lucide-react";
...
function AdminSidebar() {
  ...
  const managementItems: MenuItem[] = [
    ...
    },
    {
      key: "ai-studio",
      title: "AI Studio",
      href: "/image/ai-studio",
      icon: Sparkles,
      isActive: (loc) => loc.startsWith("/image/ai-studio"),
      permission: null,
    },
    {
      key: "ai-integration",
      title: "AI Integration",
      href: "/image/ai-integration",
      icon: BrainCircuit,
      isActive: (loc) => loc.startsWith("/image/ai-integration"),
      permission: "settings",
    },
    {
      key: "settings",
